	...
	public void generate(World world, Random random, int xCoord, int yCoord, int zCoord)
	{
		...
		if(hasSpaceToGrow)
		{
			...
			if(randomNumber < 40)
			{
				...
				{							
					world.setBlock(xCoord, yCoord+1, zCoord, Block.sapling.blockID, TreeType0, 0x2);
				}
			}
			else if(randomNumber < 70)
			{
				if(canSpawnTemp1)
				{
					world.setBlock(xCoord, yCoord+1, zCoord, Block.sapling.blockID, TreeType1, 0x2);
				}
			}
			else if(randomNumber < 100)
			{
				if(canSpawnTemp2)
				{
					world.setBlock(xCoord, yCoord+1, zCoord, Block.sapling.blockID, TreeType2, 0x2);
				}
			}
		}
	}
